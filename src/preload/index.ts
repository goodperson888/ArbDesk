...
const api: ArbAppApi = {
  ...
  startPredictFunOrderCapture: () => ipcRenderer.invoke('predict-fun:start-order-capture'),
  stopPredictFunOrderCapture: () => ipcRenderer.invoke('predict-fun:stop-order-capture'),
  getPredictFunOrderCaptureSummary: () => ipcRenderer.invoke('predict-fun:order-capture-summary'),
  clearPredictFunOrderCapture: () => ipcRenderer.invoke('predict-fun:clear-order-capture'),
  exportPredictFunOrderCapture: () => ipcRenderer.invoke('predict-fun:export-order-capture'),
  ...
  stopGateOrderCapture: () => ipcRenderer.invoke('gate:stop-order-capture'),
  ...
  exportGateOrderCapture: () => ipcRenderer.invoke('gate:export-order-capture'),
